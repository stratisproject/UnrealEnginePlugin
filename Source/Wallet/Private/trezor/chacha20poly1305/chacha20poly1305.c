...
#include <trezor/chacha20poly1305/chacha20poly1305.h>
#include <trezor/chacha20poly1305/ecrypt-portable.h>
...
void xchacha20local_poly1305_init(chacha20poly1305_ctx *ctx, const uint8_t key[32], const uint8_t nonce[24]) {
    ...
    local_poly1305_init(&ctx->poly1305, block0);
}
