...
FHttpRequestPtr UnrealApi::Unity3dApiUnity3dLocalCallPost(
    ...
    const FUnity3dApiUnity3dLocalCallPostDelegate& Delegate /*= FUnity3dApiUnity3dLocalCallPostDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
FHttpRequestPtr UnrealApi::Unity3dApiUnity3dReceiptGet(
    ...
    const FUnity3dApiUnity3dReceiptGetDelegate& Delegate /*= FUnity3dApiUnity3dReceiptGetDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
FHttpRequestPtr UnrealApi::Unity3dGetaddressbalanceGet(
    ...
    const FUnity3dGetaddressbalanceGetDelegate& Delegate /*= FUnity3dGetaddressbalanceGetDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
FHttpRequestPtr UnrealApi::Unity3dGetblockheaderGet(
    ...
    const FUnity3dGetblockheaderGetDelegate& Delegate /*= FUnity3dGetblockheaderGetDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
FHttpRequestPtr UnrealApi::Unity3dGetrawtransactionGet(
    ...
    const FUnity3dGetrawtransactionGetDelegate& Delegate /*= FUnity3dGetrawtransactionGetDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
FHttpRequestPtr UnrealApi::Unity3dGetutxosforaddressGet(
    ...
    const FUnity3dGetutxosforaddressGetDelegate& Delegate /*= FUnity3dGetutxosforaddressGetDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
FHttpRequestPtr UnrealApi::Unity3dSendTransactionPost(
    ...
    const FUnity3dSendTransactionPostDelegate& Delegate /*= FUnity3dSendTransactionPostDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
UnrealApi::Unity3dTipGet(const Unity3dTipGetRequest& Request,
                         const FUnity3dTipGetDelegate& Delegate /*= FUnity3dTipGetDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
...
FHttpRequestPtr UnrealApi::Unity3dValidateaddressGet(
    ...
    const FUnity3dValidateaddressGetDelegate& Delegate /*= FUnity3dValidateaddressGetDelegate()*/) const
{
    if (!IsValid())
        return nullptr;
